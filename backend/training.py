...
#get_training_backend() will import the neccessary packages (?)
...
xyz_folder_name = "natoms200" #bliver det her et problem? hvis man bruger et andet størrelse xyz-fil sæt?
...
def ML(X_train, y_train, X_val, y_val, model, n_threads, n_epochs): #What should these parameters be for Dr. Phil? How to use GPU?
    ...
    xgb_params = {}
    xgb_params['learning_rate'] = 0.15 #vary. Has been: 0.3
    ...
    xgb_train = xgb.DMatrix(X_train, y_train) #Lav pandas dataframe om til en hifi-xgboost format
    ...
    model = None #Hvis man ikke træner VIDERE på en model skal den her være slået til
